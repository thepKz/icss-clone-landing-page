...
export const pageSurface = {
  ...
  band: "bg-zinc-200/45 dark:bg-zinc-900/25",
  bandSoft: "bg-zinc-200/45 dark:bg-zinc-900/20",
  bandTop: "border-t border-zinc-200/95 dark:border-white/[0.06] bg-zinc-200/45 dark:bg-zinc-900/25",
  bandTopSoft: "border-t border-zinc-200/95 dark:border-white/[0.06] bg-zinc-200/45 dark:bg-zinc-900/20",
  ...
  cardMuted: "rounded-2xl border border-zinc-200/90 bg-zinc-50/95 dark:border-white/[0.06] dark:bg-zinc-950/50",
  cardSm: "rounded-xl border border-zinc-200/90 bg-zinc-50/95 dark:border-white/[0.06] dark:bg-zinc-900/40",
  cardBrief: "rounded-xl border border-zinc-200/90 bg-zinc-100/90 dark:border-white/[0.06] dark:bg-zinc-950/40",
  ...
  tableHead:
    "border-b border-zinc-200/90 bg-zinc-100 text-xs uppercase tracking-wider text-zinc-600 dark:border-white/10 dark:bg-zinc-900/50 dark:text-zinc-500",
